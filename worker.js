...
const BOT_TOKEN = "8094378614:AAE_HgKAaVaMPONQeX4hpfq9upkiTTh7IzQ"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "BOT_SECRET"; // Insert a powerful secret text.
const BOT_OWNER = 597504143; // Insert your telegram account id.
const BOT_CHANNEL = -1002678495801; // Insert your telegram channel id which the bot is admin in.
